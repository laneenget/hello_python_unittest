...
class TestStudentLists(TestCase):
    ...
    def test_add_remove_fake_student(self):
    ...
    def test_remove_no_student(self):
        test_class = ClassList(2)
        with self.assertRaises(StudentError):
            test_class.remove_student('Test Student 1')
    ...
    def test_index_of_student_empty(self):
        test_class = ClassList(3)
    ...
    def test_index_of_student(self):
        ...
        self.assertIsNone(test_class.index_of_student('Student 0'))
